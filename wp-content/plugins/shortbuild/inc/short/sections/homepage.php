 ...
 * Slider section
 */
if ( ! function_exists( 'sbp_short_slider' ) ) :
	function sbp_short_slider() {
		$slider_image = get_theme_mod('slider_image',SBP_PLUGIN_URL .'inc/short/images/slider/banner.jpg');
		  ...
		  <div class="slide-caption slide-left">
			...
			<div class="slide-inner-box">
			 ...
			 <?php } if($slider_btn_txt) {?>
			  <a class="btn-theme hidden-xs" <?php if($slider_btn_link) { ?> href="<?php echo $slider_btn_link; } ?>" 
...
if ( function_exists( 'sbp_short_slider' ) ) {
$homepage_section_priority = apply_filters( 'sbp_short_homepage_section_priority', 10, 'sbp_short_slider' );
add_action( 'sbp_short_homepage_sections', 'sbp_short_slider', absint( $homepage_section_priority ) );
